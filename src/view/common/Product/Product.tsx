...
export function Product({ data }: ProductProps) {
    ...
    return (
        <div className="w-[14rem] h-[17.2rem] mr-2 mb-2 justify-center items-center
                        ...
                        hover:bg-green-200">
            <div>
                <img className="h-[10rem] w-[10rem]" src={image} alt={data.name} />
            </div>
            <div className="flex mt-2">
                <div>
                    <h3 className="text-[#1f9e4b] text-[2rem] pl-2 pr-2">{data.name}</h3>
                </div>
                <div className="bg-yellow-300 ml-1 p-[0.3px] rounded-lg pr-2">
                    <h3 className="text-[1.4rem] pl-1">{data.price}
                        <small className="text-[0.8rem] pl-1">{data.currency}</small>
                    </h3>
                </div>
            </div>
            <div className="flex justify-center">
                {
                    item ? (
                        ...
                        <button
                            className="w-full mt-4 p-[0.5rem] bg-[#1f9e4b] text-[1rem]
